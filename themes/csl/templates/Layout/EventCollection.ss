						...
						<% loop EventData($EventID) %>
							<% if Status == 'live' || Status == 'started' %>
								<div class="news__item">
									<a href="$Link" target="_blank" class="news__cover filter-sepia"><img src="https://maps.googleapis.com/maps/api/staticmap?center=$Address,$City,$Region,$Country&zoom=13&size=368x277&maptype=roadmap" title="$Title" /></a>
